...
This string is used as a label accessor for your data.  d3reactor will look for this property in the data object. **This should match the property name of your data that holds the label for each dataset.** 
