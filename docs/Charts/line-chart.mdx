...
To create a multi-line chart, you need to use the `groupBy` prop by passing a string into this prop. **This string should match the property name of your data that represents the distinct groups you want to show.** For example, in the above dataset our groups are stored in the property name 'fruit'.
